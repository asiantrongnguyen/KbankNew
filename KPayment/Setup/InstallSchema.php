...
class InstallSchema implements InstallSchemaInterface
{
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        /**
         * Create kbank_token table
         */
        if(!$installer->tableExists('kbank/token')) {

            $table = $installer->getConnection()->newTable(
                $installer->getTable('kbank_token')
            )->addColumn(
                'kbank_id',
                ...
                $installer->getIdxName('kbank_token', ['kbank_id']),
                ['kbank_id']
            )->addForeignKey(
                $installer->getFkName('kbank_token', 'user_id', 'customer_entity', 'entity_id'),
                'user_id',
